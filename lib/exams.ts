...
const baseExams: Exam[] = [
  {
    ...
    questions: [
      q(1,'Language Focus','Which word has a different underlined sound?',['upload','cruel','puzzle','muscle'],1,'Kiến thức phát âm chữ “u”: “cruel” /ˈkruː.əl/ có âm /uː/. Trong “upload”, “puzzle” và “muscle”, phần gạch chân được đọc gần âm /ʌ/. Vì vậy “cruel” là từ có cách phát âm khác.', ['u','u','u','u']),
      q(2,'Language Focus','Choose the word with a different stress pattern.',['leisure','diving','origami','movie'],2,'Kiến thức trọng âm: “origami” /ˌɒr.ɪˈɡɑː.mi/ nhấn âm tiết thứ ba. Ba từ “leisure”, “diving”, “movie” đều nhấn âm tiết thứ nhất, nên chọn “origami”.'),
      ...
      q(6,'Reading','What is the passage mainly about?',['Problems caused by Facebook','Benefits of Facebook for students','The history of Facebook'],1,'Cách tìm ý chính: đối chiếu câu mở đầu, các ví dụ ở thân bài và câu kết. Toàn bài nói Facebook hỗ trợ giải trí, kết nối và học tập cho học sinh, nên ý “Benefits of Facebook for students” bao quát nhất.'),
      ...
      q(8,'Reading','Where can students meet people with similar interests?',['Messenger calls','Facebook comments only','Facebook pages'],2,'Trong bài có chi tiết học sinh kết nối với người cùng sở thích “through Facebook pages”. Vì vậy chọn “Facebook pages”; hai lựa chọn còn lại không khớp thông tin trực tiếp.'),
  ...
  },
  {
    ...
    questions: [
      ...
      q(8,'Reading','Did bullying occur more frequently in secondary schools?',['Yes, much more often','No, it occurred less frequently','The passage does not say'],1,'Bài nói bắt nạt dai dẳng ở trường trung học xảy ra ít thường xuyên hơn, dù khó xử lý hơn. Vì vậy chọn ý “No, it occurred less frequently”.'),
  ...
  },
  {
    ...
    questions: [
      ...
      q(8,'Reading','What do many British people associate with the countryside?',['Work in towns','Heavy traffic','Peace and relaxation','Public offices'],2,'Bài nhấn mạnh người Anh tận hưởng sự yên bình và thư giãn của cuộc sống nông thôn. Vì vậy “Peace and relaxation” là ý đúng và bao quát.'),
      ...
      q(10,'Reading','Where do many rural residents work today?',['On farms','In towns','In national parks','On the coastline'],1,'Bài nói ngày nay ít người nông thôn làm việc tại trang trại; nhiều người đi làm ở thị trấn. Do đó chọn “In towns”.'),
    ],
  },
  {
    id: 6,
...
const extraSets: Record<number, Question[]> = {
  1: makeExtras([
    ['Choose the word whose underlined part is pronounced differently.',['school','character','chemistry','children'],3,'“ch” trong children đọc /tʃ/; trong school, character và chemistry đọc /k/. Vì vậy “children” có phần gạch chân phát âm khác.',['ch','ch','ch','ch']],
    ['Choose the word with a different stress pattern.',['leisure','hobby','enjoy','social'],2,'Leisure, hobby và social nhấn âm 1; enjoy nhấn âm 2: /ɪnˈdʒɔɪ/. Vì vậy chọn “enjoy”.'],
