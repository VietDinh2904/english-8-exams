...
export const exams9: Exam[] = [
  ...unitExams9,
  {
    ...
    questions: [
      q(1, 'Language Focus', 'Choose the word whose underlined part is pronounced differently.', ['thank', 'father', 'theatre', 'healthy'], 1, 'Phần “th” trong “father” được phát âm /ð/ (âm hữu thanh). Trong “thank”, “theatre” và “healthy”, “th” được phát âm /θ/ (âm vô thanh). Vì vậy “father” khác ba từ còn lại.', ['th', 'th', 'th', 'th']),
      q(2, 'Language Focus', 'Choose the word with a different stress pattern.', ['suburb', 'neighbour', 'tourist', 'remind'], 3, '“Suburb”, “neighbour” và “tourist” đều nhấn âm tiết thứ nhất. “Remind” /rɪˈmaɪnd/ nhấn âm tiết thứ hai, nên chọn “remind”.'),
  ...
  },
  {
    ...
    questions: [
      q(1, 'Language Focus', 'Choose the word whose underlined part is pronounced differently.', ['honest', 'homework', 'handmade', 'healthy'], 0, 'Chữ “h” trong “honest” là âm câm, từ bắt đầu bằng nguyên âm /ˈɒnɪst/. Ba từ còn lại đều phát âm /h/ ở đầu. Vì vậy chọn “honest”.', ['h', 'h', 'h', 'h']),
      q(2, 'Language Focus', 'Choose the word whose underlined part is pronounced differently.', ['market', 'card', 'depart', 'scare'], 3, 'Phần “ar” trong market, card và depart có âm /ɑː/. Trong “scare”, phần tương ứng tạo âm /eə/, nên “scare” khác.', ['ar', 'ar', 'ar', 'ar']),
      q(3, 'Language Focus', 'Choose the word whose underlined part is pronounced differently.', ['thread', 'pleasure', 'deadline', 'treat'], 3, '“ea” trong thread, pleasure và deadline được đọc /e/. Trong “treat”, “ea” đọc /iː/, nên chọn “treat”.', ['ea', 'ea', 'ea', 'ea']),
      q(4, 'Language Focus', 'Choose the word with a different stress pattern.', ['village', 'football', 'object', 'invent'], 3, 'Village, football và object (danh từ) nhấn âm đầu. Invent /ɪnˈvent/ nhấn âm thứ hai, nên chọn “invent”.'),
      q(5, 'Language Focus', 'Choose the word with a different stress pattern.', ['suburb', 'neighbour', 'people', 'advice'], 3, 'Suburb, neighbour và people nhấn âm đầu. Advice /ədˈvaɪs/ nhấn âm thứ hai, nên chọn “advice”.'),
